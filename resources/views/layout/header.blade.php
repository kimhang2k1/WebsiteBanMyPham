            ...
            <div class="right">
                ...
                @if(session()->has('user')) 
                    <ul style = "display:inline-flex;list-style:none;margin:0;">
                        ...
                        <li style = "line-height:30px;padding-left:10px;font-size:17px;cursor: pointer;" onclick="window.location.href='{{ url('profile')}}'"><span> {{Session::get('user')[0]->TenDangNhap}}</span></li>
                   </ul>
                    <div class = "account-1" >
