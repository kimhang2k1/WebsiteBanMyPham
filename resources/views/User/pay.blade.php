        ...
        <div class = "payment">
            @if(count($diaChi) < 0) 
               <div class = "insert-address" id="myModal" style="display:block;" >
                     @include('User/component/form-add-address', ['thanhPho' => $thanhPho, 'quan' => $quan, 'xa' => $xa])
              </div>
            ...
            @else 
                @if(count($diaChiGiaoHang) > 0)
                    <div class = "address" id = "default-address"style = "display:block;" >
                      @include('User/component/addressCustomer', ['diaChiGiaoHang' => $diaChiGiaoHang])
                    </div> 
                    <div class  = "row-address-customer" id = "myAddress" style = "display:none;">
                        @include('User/component/delivery-address', ['diaChi' => $diaChi])
                    </div>
