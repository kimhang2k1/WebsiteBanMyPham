...
class profileController extends Controller
{
    public function getProfile(Request $request) {
        ...
        return view('User/profile-customer')->with('ttkh', $ttkh)->with('dc', $dc)->with('thanhPho', $thanhPho)->with('xa', $xa)->with('quan', $quan)
    ...
    public function getInput(Request $request) {
        ...
        ->leftJOIN('quanhuyen', 'thongtinkhachhang.IDQuan','=','quanhuyen.IDQuan')
        ->leftJOIN('xa', 'thongtinkhachhang.IDXa','=','xa.IDXa')->get(); 
        return view('User/component/form-edit-address')->with('input', $input)->with('thanhPho', $thanhPho)->with('xa', $xa)->with('quan', $quan);
    }
    public function editAddressCustomer(Request $request) {
       ...
       
        {
            ...
            return response()->json([
                'view' => "" . view('User/component/allMyAddress')->with('dc', $dc)->with('diaChi', $diaChi)->with('thanhPho', $thanhPho)->with('xa', $xa)->with('quan', $quan)]);
        }
    }
    ...
    public function editDefaultAddress(Request $request)
    {
       ...
       ->leftJOIN('quanhuyen', 'thongtinkhachhang.IDQuan','=','quanhuyen.IDQuan')
       ->leftJOIN('xa', 'thongtinkhachhang.IDXa','=','xa.IDXa')->get();
       return view('User/component/allMyAddress')->with('dc', $dc)->with('diaChi', $diaChi);
    }
    ...
    public function checkBill(Request $request) {
       ...
       return view('User/component/bill')->with('order', $order);
}
    }
