...
class OrderController extends Controller
{
    public function addOrder(Request $request) {
           ...
           $datetime->modify('+2 day');
            ...
            $IDDiaChiGiaoHang = DB::table('diachigiaohang')->JOIN('thongtinkhachhang', 'thongtinkhachhang.ID','=', 'diachigiaohang.IDDiaChi')
            ...
            if(count($order) > 0) {
                ...
                DonHang::create('DELTA'.$number,$id,$currentDateTime, $datetime->format('Y-m-d H:i:s'), $IDDiaChiGiaoHang[0]->IDDiaChi, 'Chưa Giao Hàng');
            }
            else {
                $string = "DELTA1000000";
                $data = explode('DELTA',$string);
                ...
                DonHang::create('DELTA'.$number,$id,$currentDateTime, $datetime->format('Y-m-d H:i:s'), $IDDiaChiGiaoHang[0]->IDDiaChi, NULL);
            }
